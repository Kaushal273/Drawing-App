package com.example.drwawingapp
            ...
            if(requestCode == GALLERY){
                try {
                    if(data!!.data != null){
                        ...
                        Toast.makeText(this@MainActivity, "Error in Uploading image.", Toast.LENGTH_SHORT).show()
                    }
                }catch (e: Exception){
                    e.printStackTrace()
                }
    ...
    override fun onRequestPermissionsResult(
        ...
        if(requestCode == STORAGE_PERMISSION_CODE){
            if(grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                Toast.makeText(this@MainActivity, "Permission granted for reading the storage files.", Toast.LENGTH_LONG).show()
            }else{
